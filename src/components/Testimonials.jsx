  ...
  const reviews = [
    {
      ...
      review: 'I regularly book YUVA CABS for transfers from Hosur to Bengaluru Airport (BLR). They are extremely punctual, their pricing is transparent, and the clean interior of their sedans makes the ride very relaxing.',
      rating: 5,
    ...
    },
    {
      ...
      review: 'Corporate logistics requires extreme reliability. We trust YUVA CABS for all executive transport and client hospitality rides. Their professional driver behavior and clean billing have made them our default partner.',
      rating: 5,
    ...
    },
    {
      ...
      review: 'As a solo female traveler, safety is my primary concern. YUVA CABS driver verification and real-time support make me feel completely safe even during late-night airport arrivals. Highly recommended for everyone in Hosur!',
      rating: 5,
