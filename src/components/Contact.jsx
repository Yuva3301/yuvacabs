  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      try {
        ...
        const existingBookings = JSON.parse(localStorage.getItem('yuvacabs_bookings') || '[]');
        localStorage.setItem('yuvacabs_bookings', JSON.stringify([newBooking, ...existingBookings]));
        
        // Dispatch a custom event to notify the AdminDashboard if it's currently rendered
        window.dispatchEvent(new Event('yuvacabs_booking_submitted'));
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-brand-gray/95 font-medium max-w-md">
                      Thank you for choosing YUVA CABS. Your taxi slot request has been logged persistently in our dispatch queue. Our booking coordinator will phone you at <strong className="text-brand-yellow font-bold">your contact number</strong> within 5 minutes to confirm vehicle assignment.
                    </p>
                  </div>
